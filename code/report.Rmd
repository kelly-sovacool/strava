...
```{r}
knitr::include_graphics(here::here('figures', 'point_ride_speed.png'))
knitr::include_graphics(here::here('figures', 'point_run_pace.png'))
```
...
knitr::include_graphics(here::here('figures', 'point_ride_dist.png'))
knitr::include_graphics(here::here('figures', 'point_run_dist.png'))
```
