...
#' adapted by KLS from https://github.com/AtherEnergy/ggTimeSeries/blob/master/R/ggplot_calendar_heatmap.R
#'    and from https://gist.github.com/marcusvolz/84d69befef8b912a3781478836db9a75
#' 
...
#' }
ggplot_calendar_heatmap_KLS <- function(dtDateValue,
                                    cDateColumnName = "",
                                    cValueColumnName = "",
                                    ...
                                    fill_label= "hrs") {
    dtDateValue = data
    cDateColumnName = "start_date"
    cValueColumnName = "elapsed_time_hrs"
    vcGroupingColumnNames = "Year"
    dayBorderSize = 0.5
    dayBorderColour = "white"
    monthBorderSize = 0.75
    ...
    ggplotcalendar_heatmap <- ggplotcalendar_heatmap +
        ...
        xlab(NULL) +
        ylab(NULL) +
        scale_fill_continuous(name = fill_label, low = "#DAE580", high = "#236327", na.value = "#e7eaec") +
